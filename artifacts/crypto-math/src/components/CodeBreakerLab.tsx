...
import { Shield, Search, Gamepad2, Target, Trophy, Crown } from "lucide-react";
...
type Tab = "challenge" | "cracker" | "guess" | "missions" | "achievements" | "master";
        ...
        <div className="grid grid-cols-3 sm:grid-cols-6 gap-2 mb-8">
          {TABS.map((t) => (
            <button key={t.id} onClick={() => setTab(t.id)}
              ...
              <div className={tab === t.id ? "text-white" : ""}>{t.icon}</div>
